...
registerStyles(
  'vaadin-button',
  css`
    [part] ::slotted(vaadin-icon[icon^='far:']), [part] ::slotted(iron-icon[icon^='far:']) 
    {
      padding: 0.25em;
...
<fc-iconset name="far">
   <object type="application/json" slot="alias">
